...
%let EM_NUM_VARS = 9;
   %macro EM_VARS;
    BAD IMP_DEBTINC IMP_DELINQ IMP_DEROG IMP_JOB IMP_MORTDUE IMP_NINQ IMP_REASON
   IMP_YOJ
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
    BAD IMP_DELINQ IMP_DEROG IMP_JOB IMP_NINQ IMP_REASON
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 3;
   %macro EM_INTERVAL;
    IMP_DEBTINC IMP_MORTDUE IMP_YOJ
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 8;
   %macro EM_INPUT;
    IMP_DEBTINC IMP_DELINQ IMP_DEROG IMP_JOB IMP_MORTDUE IMP_NINQ IMP_REASON
   IMP_YOJ
   %mend EM_INPUT;
...
%let EM_NUM_NOMINAL_INPUT = 4;
   %macro EM_NOMINAL_INPUT;
    IMP_DELINQ IMP_DEROG IMP_JOB IMP_NINQ
