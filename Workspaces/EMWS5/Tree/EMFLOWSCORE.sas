...
_ARBFMT_12 = PUT( default , BEST12.);
 %DMNORMCP( _ARBFMT_12, F_default );
...
*****  RESIDUALS R_ *************;
IF  F_default  NE '1'
AND F_default  NE '0'  THEN DO;
        R_default1  = .;
        R_default0  = .;
 END;
 ELSE DO;
       R_default1  =  -P_default1 ;
       R_default0  =  -P_default0 ;
       SELECT( F_default  );
          WHEN( '1'  ) R_default1  = R_default1  +1;
          WHEN( '0'  ) R_default0  = R_default0  +1;
       END;
 END;
