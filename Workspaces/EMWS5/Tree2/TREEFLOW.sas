...
label R_I_default0 = 'Residual: I_default=0' ;
label R_I_default1 = 'Residual: I_default=1' ;
label F_I_default = 'From: I_default' ;
...
_ARBFMT_12 = PUT( I_default , $12.);
 %DMNORMCP( _ARBFMT_12, F_I_default );
...
*****  RESIDUALS R_ *************;
IF  F_I_default  NE '0' 
AND F_I_default  NE '1'  THEN DO; 
        R_I_default0  = .;
        R_I_default1  = .;
 END;
 ELSE DO;
       R_I_default0  =  -P_I_default0 ;
       R_I_default1  =  -P_I_default1 ;
       SELECT( F_I_default  );
          WHEN( '0'  ) R_I_default0  = R_I_default0  +1;
          WHEN( '1'  ) R_I_default1  = R_I_default1  +1;
       END;
 END;
